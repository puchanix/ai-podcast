...
export const personas = {
  daVinci: {
    ...
    // Use a function to get the voice ID dynamically
    get voiceId() {
      // Look for the voice ID in the map (eleonardo -> ELEONARDO_VOICE_ID)
      return voiceIdMap["eleonardo"] || null
    },
  ...
  socrates: {
    ...
    get voiceId() {
      return voiceIdMap["socrates"] || null
    },
  ...
  shakespeare: {
    ...
    get voiceId() {
      return voiceIdMap["shakespeare"] || null
    },
